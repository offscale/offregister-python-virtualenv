...
This package follows the offregister specification to handle python virtual environments (venvs), including inline to offregister execution within the venv.
